...
public:
	...
	void Focus(class ATransformerActor* Caller, class USceneComponent* Component, bool bComponentBased);

	
	//Unfocus is called right before the Component is removed from the list.
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Focusable")
	void Unfocus(class ATransformerActor* Caller, class USceneComponent* Component, bool bComponentBased);
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Focusable")
	void OnNewTransformation(class ATransformerActor* Caller, class USceneComponent* Component, const FTransform& NewTransform, bool bComponentBased);
